...
import { Home, BarChart3, ShoppingCart, Package, Users, Bus, ScanBarcode, Crown, Warehouse, Percent } from "lucide-react";
...
const menuItems = [
  ...
  { href: "/stok", label: "Manajemen Stok", icon: Warehouse },
  { href: "/diskon", label: "Diskon & Promosi", icon: Percent },
