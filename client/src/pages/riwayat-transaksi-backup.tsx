  ...
  return (
    <div className="space-y-6">
      <Header 
        ...
        subtitle="Kelola dan pantau semua transaksi yang telah dilakukan" 
      />
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-qasir-text-light text-sm">Total Nilai</p>
                <p className="text-2xl font-bold text-qasir-text">{formatCurrency(totalNilai)}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-qasir-text">{transaksiSelesai}</p>
              </div>
              <div className="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center">
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-qasir-text-light text-sm">Dibatalkan</p>
                <p className="text-2xl font-bold text-qasir-text">{transaksiDibatalkan}</p>
              </div>
      ...
      <Card>
        <CardHeader>
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <CardTitle className="text-xl font-bold text-qasir-text">Daftar Transaksi</CardTitle>
            <Button 
              variant="outline"
