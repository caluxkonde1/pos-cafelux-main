...
export default function Pengingat() {
  ...
  return (
    <div className="space-y-6">
      <Header 
        title="Pengingat" 
        subtitle="Kelola pengingat dan notifikasi untuk bisnis Anda" 
      />
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-qasir-text-light text-sm">Aktif</p>
                <p className="text-2xl font-bold text-qasir-text">{aktifCount}</p>
              </div>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-qasir-text-light text-sm">Prioritas Tinggi</p>
                <p className="text-2xl font-bold text-qasir-text">{tinggiCount}</p>
              </div>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-qasir-text-light text-sm">Selesai</p>
                <p className="text-2xl font-bold text-qasir-text">{selesaiCount}</p>
              </div>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-qasir-text-light text-sm">Terlewat</p>
                <p className="text-2xl font-bold text-qasir-text">{terlewatCount}</p>
              </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-xl font-bold text-qasir-text">Daftar Pengingat</CardTitle>
        </CardHeader>
        <CardContent>
          {isLoading ? (
